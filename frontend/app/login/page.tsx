...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ background: BG }}>
      {/* Dekorasi lingkaran (mirip Figma) */}
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col px-6 pb-12 pt-10 sm:px-8 sm:pt-14">
        ...
        <GoogleLoginButton containerId="google-signin-login" />

        <p className="mt-auto pt-10 text-center text-base text-white/90">
          Belum punya akun?{" "}
          <Link href="/signup" className="font-black italic text-white underline decoration-white/50 underline-offset-4 hover:decoration-white">
            Sign Up
          </Link>
        </p>
      </div>
