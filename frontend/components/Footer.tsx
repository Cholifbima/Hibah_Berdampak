          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="mt-2">
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/profile.php?id=100067483230790" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 hover:bg-[#1877f2]/10 transition-colors group">
                  <svg viewBox="0 0 24 24" className="h-4 w-4 fill-gray-400 group-hover:fill-[#1877f2] transition-colors">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://shopee.co.id/top.production06" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 hover:bg-[#ee4d2d]/10 transition-colors p-2">
                  <Image src="/assets/icons/IkonHibah/shoope.png" alt="Shopee" width={24} height={24} className="w-full h-full object-contain opacity-50 hover:opacity-100 transition-opacity" />
                </a>
                <a href="https://s.lazada.co.id/s.ZkgOfO" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 hover:bg-[#0f146d]/10 transition-colors p-2">
                  <Image src="/assets/icons/IkonHibah/lazada.png" alt="Lazada" width={24} height={24} className="w-full h-full object-contain opacity-50 hover:opacity-100 transition-opacity" />
                </a>
              </div>
            </div>
          </div>
